...
<body>
	<form action="${contextPath}/member/contents1/registerMember" method="post">
		<h3>회원가입</h3>
	<table border="1">
		<tr>
				<td>아이디</td>
		    ...
		    <tr>
		        <td colspan="2" align="center">
		        	이미 회원가입이 되어있다면 ? <a href="${contextPath}/member/contents2/loginMember"><strong>로그인하기</strong></a>
		        </td>
	        </tr>                            
	     </table>
	</form>
