...
public class BoardAdvanceController {
	...
	public ModelAndView boardAuthentication(@RequestParam("menu") String menu ,
		...
		ModelAndView mv = new ModelAndView();
		mv.setViewName("/boardAdvance/boardAuthentication");
		mv.addObject("mainBoardDTO" , boardAdvanceService.getBoardDetail(boardId , true));
	...
	public ResponseEntity<Object> boardAuthentication(@RequestParam("menu") String menu ,
		...
		if (boardAdvanceService.checkAuthorizedUser(mainBoardDTO)) {
			...
			if (menu.equals("update")) {
				jsScript = "<script>";
				jsScript += "location.href='" + request.getContextPath() + "/boardAdvance/modifyBoard?boardId=" + mainBoardDTO.getBoardId() + "';";
				jsScript += "</script>";
			}
			else if (menu.equals("delete")) {
				jsScript = "<script>";
				jsScript += "location.href='"+ request.getContextPath() + "/boardAdvance/removeBoard?boardId=" +  mainBoardDTO.getBoardId() + "';";
				jsScript += "</script>";
			}
	...
	public ResponseEntity<Object> removeBoard(@RequestParam("boardId") long boardId , HttpServletRequest request) throws Exception{
